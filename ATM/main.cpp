...
int main()
{
	...
	cout << "В банкомате: " << arr[0] / 100 << " купюр по 100 рублей" << endl;
	cout << "В банкомате: " << arr[1] / 200 << " купюр по 200 рублей" << endl;
	cout << "В банкомате: " << arr[2] / 500 << " купюр по 500 рублей" << endl;
	cout << "В банкомате: " << arr[3] / 1000 << " купюр по 1000 рублей" << endl;
	cout << "В банкомате: " << arr[4] / 2000 << " купюр по 2000 рублей" << endl;
	cout << "В банкомате: " << arr[5] / 5000 << " купюр по 5000 рублей" << endl;
	...
	cout << "Остаток в банкомате: " << arr[0] / 100 << " купюр по 100 рублей" << endl;
	cout << "Остаток в банкомате: " << arr[1] / 200 << " купюр по 200 рублей" << endl;
	cout << "Остаток в банкомате: " << arr[2] / 500 << " купюр по 500 рублей" << endl;
	cout << "Остаток в банкомате: " << arr[3] / 1000 << " купюр по 1000 рублей" << endl;
	cout << "Остаток в банкомате: " << arr[4] / 2000 << " купюр по 2000 рублей" << endl;
	cout << "Остаток в банкомате: " << arr[5] / 5000 << " купюр по 5000 рублей" << endl;
